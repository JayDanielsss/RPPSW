...
smiData.Solid(1).CoM = [0 17.419651731109379 0];  % mm
smiData.Solid(1).MoI = [103.13461432659138 96.281778161875067 95.792299852394621];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 0.26076272015520857;  % kg
smiData.Solid(3).CoM = [0 194.83185262252761 0.011294724610124453];  % mm
smiData.Solid(3).MoI = [6862.7295248597457 30.007740287363852 6862.6840500287481];  % kg*mm^2
smiData.Solid(3).PoI = [-0.86934195316380058 0 0];  % kg*mm^2
smiData.Solid(3).color = [0.48588235294117643 0.068627450980392149 0.068627450980392149];
smiData.Solid(3).opacity = 1;
smiData.Solid(3).ID = "JayRPPPrismatic2*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 0.099893180326794909;  % kg
smiData.Solid(4).CoM = [25.399999999999991 54.134499972325521 -25.40628990416225];  % mm
smiData.Solid(4).MoI = [50.25748087895014 44.952064722953871 52.900303056161199];  % kg*mm^2
smiData.Solid(4).PoI = [0.020147347864141886 0 0];  % kg*mm^2
...
smiData.Solid(5).MoI = [9391.6974999999984 65732.073920533818 65694.886420533818];  % kg*mm^2
smiData.Solid(5).PoI = [0 0 0];  % kg*mm^2
smiData.Solid(5).color = [0.69999999999999996 0.65607843137254895 0.096078431372549025];
smiData.Solid(5).opacity = 1;
smiData.Solid(5).ID = "JayRPPPrismatic1*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(6).mass = 0.030922565104551512;  % kg
smiData.Solid(6).CoM = [0 9.0282850081755797 0];  % mm
smiData.Solid(6).MoI = [11.515450173397165 6.9996952926648888 6.3580022337539237];  % kg*mm^2
smiData.Solid(6).PoI = [0 0 0];  % kg*mm^2
smiData.Solid(6).color = [0.20039215686274509 0.46392156862745093 0.23058823529411762];
smiData.Solid(6).opacity = 1;
smiData.Solid(6).ID = "jaywrist2*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(7).mass = 5.9628867028761281;  % kg
smiData.Solid(7).CoM = [122.50284034303007 81.128553273933662 0];  % mm
smiData.Solid(7).MoI = [15214.903355506438 112072.0361995498 114676.43325113872];  % kg*mm^2
smiData.Solid(7).PoI = [-0.00015683372419048554 0 93.90438168322099];  % kg*mm^2
smiData.Solid(7).color = [0.20039215686274509 0.46392156862745093 0.23058823529411762];
smiData.Solid(7).opacity = 1;
smiData.Solid(7).ID = "JayRPPRotation*:*Default";
