...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(12).translation = [-1.2434497875801753e-14 39.999999999995836 1.2114753644709708e-12];  % mm
...
smiData.Solid(1).mass = 0.005759586531581303;  % kg
smiData.Solid(1).CoM = [0 12.27272727272727 0];  % mm
smiData.Solid(1).MoI = [0.97817771259500641 0.26703537555513374 0.97817771259500641];  % kg*mm^2
smiData.Solid(1).PoI = [0 0 0];  % kg*mm^2
smiData.Solid(1).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(1).opacity = 1;
smiData.Solid(1).ID = "Jaytool*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 6.4529729867849968;  % kg
smiData.Solid(2).CoM = [0 189.54313126504013 0];  % mm
smiData.Solid(2).MoI = [90555.497800988145 17318.549822939458 90555.497800988145];  % kg*mm^2
smiData.Solid(2).PoI = [0 0 0];  % kg*mm^2
smiData.Solid(2).color = [0.0054901960784313718 0.16745098039215683 0.57647058823529407];
smiData.Solid(2).opacity = 1;
smiData.Solid(2).ID = "JayRPPBase*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 5.9628867028761281;  % kg
smiData.Solid(3).CoM = [122.50284034303007 81.128553273933662 0];  % mm
smiData.Solid(3).MoI = [15214.90335550644 112072.0361995498 114676.43325113872];  % kg*mm^2
smiData.Solid(3).PoI = [-0.00015683372417715541 0 93.904381683221473];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(4).mass = 0.16765128751525624;  % kg
smiData.Solid(4).CoM = [0 17.419651731109383 0];  % mm
smiData.Solid(4).MoI = [103.13461432659138 96.281778161875067 95.792299852394621];  % kg*mm^2
smiData.Solid(4).PoI = [0 0 0];  % kg*mm^2
smiData.Solid(4).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(4).opacity = 1;
smiData.Solid(4).ID = "jaywrist1*:*Default";

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(5).mass = 0.030922565104551512;  % kg
smiData.Solid(5).CoM = [0 9.0282850081755814 0];  % mm
smiData.Solid(5).MoI = [11.515450173397165 6.9996952926648879 6.3580022337539246];  % kg*mm^2
...
smiData.Solid(6).MoI = [9391.6974999999984 65732.073920533818 65694.886420533818];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(7).mass = 0.26076272015520852;  % kg
smiData.Solid(7).CoM = [0 194.83185262252761 0.011294724610124351];  % mm
smiData.Solid(7).MoI = [6862.7295248597447 30.007740287363852 6862.6840500287472];  % kg*mm^2
smiData.Solid(7).PoI = [-0.86934195316379814 0 0];  % kg*mm^2
smiData.Solid(7).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(7).opacity = 1;
smiData.Solid(7).ID = "JayRPPPrismatic2*:*Default";
